                    ...
                    <div class="card-body card-block">
                        ...
                        <form method="POST" action="{{route('eventos.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control @error('subTitulo') is-invalid @enderror" id="subTitulo" name="subTitulo" required>
                                @error('subTitulo')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control @error('descricao') is-invalid @enderror" id="descricao" name="descricao" required>
                                @error('descricao')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control @error('local') is-invalid @enderror"  id="local" name="local" required>
                                @error('local')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date"  class="form-control @error('data_inicio') is-invalid @enderror"  id="data_inicio" name="data_inicio" required>
                                @error('data_inicio')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date"  class="form-control @error('data_fim') is-invalid @enderror"  id="data_fim" name="data_fim" required>
                                @error('data_fim')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control @error('organizador') is-invalid @enderror"  id="organizador" name="organizador" required>
                                @error('organizador')
                                    <span class="invalid-feedback">
                                        {{$message}}
                                    </span>
                            ...
                            <div class="input-group mb-3">
                              ...
                              <div>
                                <button type="submit" class="btn btn-lg btn-info btn-block">Criar Evento</button>
                            </div>
                        </form>
                    </div>
                </div>
