                    ...
                    <div class="card-body card-block">
                        ...
                        <form method="POST" action="{{route('eventos.atividades.update', ['evento' => $evento->id, 'atividade' => $atividade->id])}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control @error('titulo') is-invalid @enderror" id="titulo" name="titulo"  value="{{$atividade->titulo}}" required>
                                @error('titulo')
                            ...
                            <input type="text"  class="form-control @error('descricao') is-invalid @enderror" id="descricao" name="descricao" value="{{$atividade->descricao}}" required>
                                @error('descricao')
                                    <span class="invalid-feedback">
                                    {{$message}}
                                    </span>
                            ...
                            <input type="text"  class="form-control @error('mediador') is-invalid @enderror" id="mediador" name="mediador" value="{{$atividade->mediador}}"required>
                                @error('mediador')
                                    <span class="invalid-feedback">
                                    {{$message}}
                                    </span>
                            ...
                            <input type="number"  class="form-control @error('cargaHoraria') is-invalid @enderror" id="cargaHoraria" name="cargaHoraria"value="{{$atividade->cargaHoraria}}" required>
                                @error('cargaHoraria')
                                    <span class="invalid-feedback">
                                    {{$message}}
                                    </span>
                            ...
                            <input type="number"  class="form-control @error('qtd_vagas') is-invalid @enderror" id="qtd_vagas" name="qtd_vagas" value="{{$atividade->qtd_vagas}}" required>
                                @error('qtd_vagas')
                                    <span class="invalid-feedback">
                                    {{$message}}
                                    </span>
