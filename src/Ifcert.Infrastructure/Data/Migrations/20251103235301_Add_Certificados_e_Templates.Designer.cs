...
namespace Ifcert.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251103235301_Add_Certificados_e_Templates")]
    partial class Add_Certificados_e_Templates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ifcert.Domain.Entities.Certificado", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("InscricaoId")
                        .IsUnique()
                        .HasDatabaseName("ux_certificado_inscricao");

                    b.ToTable("certificados", (string)null);
                });

            modelBuilder.Entity("Ifcert.Domain.Entities.CertificadoTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("certificado_templates", (string)null);
                });
            ...
            modelBuilder.Entity("Ifcert.Domain.Entities.Certificado", b =>
                {
                    b.OwnsOne("Ifcert.Domain.ValueObjects.CodigoCertificado", "Codigo", b1 =>
                        {
